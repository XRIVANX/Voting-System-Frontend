                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-[var(--border-color)] bg-[var(--bg-main)]/50">
                                ...
                                <th className="px-6 py-5 text-xs font-black uppercase tracking-widest text-[var(--text-main)]">
                                    Identification
                                </th>
                                <th className="px-6 py-5 text-xs font-black uppercase tracking-widest text-[var(--text-main)]">
                                    Options
                                ...
                                <th className="px-6 py-5 text-xs font-black uppercase tracking-widest text-[var(--text-main)] text-right">
                                    Actions
                                </th>
                            </tr>
                        </thead>
